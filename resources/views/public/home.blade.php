        ...
        <div class="max-w-3xl">
            ...
            <div class="mt-14 grid grid-cols-3 gap-6 border-t border-white/20 pt-10">
                <div>
                    ...
                    <p class="text-sm text-blue-200 mt-1">Status utama order</p>
                </div>
                <div>
                    <p class="text-3xl font-bold text-white">24/7</p>
                    <p class="text-sm text-blue-200 mt-1">Tracking publik</p>
                </div>
                <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            $features = [
                ...
                [
                    ...
                    'desc' => 'Pantau setiap order dari "Draft" hingga "Selesai" melalui status yang jelas dan terstruktur.',
...
<section class="py-20 bg-blue-700 text-white" aria-labelledby="cta-heading">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-blue-100 mb-10">
            Hubungi kami untuk menyiapkan akses dan mulai kelola bisnis Anda secara profesional.
        </p>
